...
public class PSendAccessories extends PacketBase {
	public int id;
	public int slot;
	public ItemStack stack;
	public PSendAccessories() {}
	public PSendAccessories(ExtendedPlayer extendedPlayer, int slot) {
	...
	public void execute(EntityPlayer var1, Side var2) throws ProtocolException {
		...
		ep.invAccs.inventory[this.slot] = this.stack;
